<aside class="left-sidebar">
    ...
    <div class="scroll-sidebar">
        <!-- User profile -->
        <div class="user-profile" style="background: url({{asset('backend/assets/images/background/user-info.jpg')}}) no-repeat;">
            <!-- User profile image -->
            <div class="profile-img"> <img src="{{asset('backend/assets/images/users/profile.png')}}" alt="user" /> </div>
            <!-- User profile text-->
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-emoticon-cool"></i><span class="hide-menu">Videos</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{route('admin.videos')}}">View Videos</a></li>
                        <li><a href="{{route('admin.videos.import')}}">Import Videos</a></li>
                    </ul>
                </li>
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-emoticon-cool"></i><span class="hide-menu">Category</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{route('admin.categories')}}">View Categories</a></li>
                        <li><a href="{{route('admin.categories.new')}}">Add New</a></li>
                    </ul>
                </li>
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-emoticon-cool"></i><span class="hide-menu">Channels</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{route('admin.channels')}}">View Channels</a></li>
                        <li><a href="{{route('admin.channels.new')}}">Add New</a></li>
                    </ul>
                </li>
