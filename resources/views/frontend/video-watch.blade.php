...
<!--breadcrumbs-->
@include('frontend.sections.breadcrumb', ['current' => $video->title, 'items' => ['channel' => route('channels'), $video->channel->title => route('channels.single', ['slug' => $video->channel->slug])]])
<!--end breadcrumbs-->
