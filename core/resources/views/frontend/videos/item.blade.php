            ...
            <div class="row secBg">
                <div class="large-12 columns inner-flex-video">
                    <div class="flex-video widescreen">
                        <iframe class="ld" width="560" height="315" src="{{asset('assets/images/preload.png')}}"  data-original="{{config('youtube.embed') .$video->video_id}}?rel=0" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="media-object-section">
                            <div class="author-img-sec">
                                <div class="thumbnail author-single-post">
                                    <a href="{{route('channels.single', ['slug' => $video->channel->slug])}}"><img class="ld" src="{{asset('assets/images/preload.png')}}"  data-original= "{{$video->channel->thumbnail}}" alt="{{$video->channel->seo_title}}"></a>
                                </div>
