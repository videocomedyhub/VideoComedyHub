...
<div class="row">
    ...
    <div class="col-lg-4 col-xlg-3 col-md-5">
        <div class="card blog-widget">
            <div class="card-body">
                <div class="blog-image"><img src="{{asset('backend/assets/images/big/img1.jpg')}}" alt="img" class="img-responsive"/></div>
...
<div class="row">
    ...
    <div class="col-lg-4 col-md-4">
        <div class="card">
            <img class="" src="{{asset('backend/assets/images/background/weatherbg.jpg')}}" alt="Card image cap">
                ...
                <div class="tab-pane active" id="home" role="tabpanel">
                    <div class="card-body">
                        <div class="profiletimeline">
                            <div class="sl-item">
                                <div class="sl-left"> <img src="{{asset('backend/assets/images/users/1.jpg')}}" alt="user" class="img-circle"> </div>
                                <div class="sl-right">
                                    <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                        <p>assign a new task <a href="#"> Design weblayout</a></p>
                                        <div class="row">
                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="{{asset('backend/assets/images/big/img1.jpg')}}" alt="user" class="img-responsive radius"></div>
                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="{{asset('backend/assets/images/big/img2.jpg')}}" alt="user" class="img-responsive radius"></div>
                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="{{asset('backend/assets/images/big/img3.jpg')}}" alt="user" class="img-responsive radius"></div>
                                            <div class="col-lg-3 col-md-6 m-b-20"><img src="{{asset('backend/assets/images/big/img4.jpg')}}" alt="user" class="img-responsive radius"></div>
                                        </div>
                            ...
                            <hr>
                            <div class="sl-item">
                                <div class="sl-left"> <img src="{{asset('backend/assets/images/users/2.jpg')}}" alt="user" class="img-circle"> </div>
                                <div class="sl-right">
                                    <div> <a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                        <div class="m-t-20 row">
                                            <div class="col-md-3 col-xs-12"><img src="{{asset('backend/assets/images/big/img1.jpg')}}" alt="user" class="img-responsive radius"></div>
                            ...
                            <hr>
                            <div class="sl-item">
                                <div class="sl-left"> <img src="{{asset('backend/assets/images/users/3.jpg')}}" alt="user" class="img-circle"> </div>
                                <div class="sl-right">
                                    <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                            ...
                            <hr>
                            <div class="sl-item">
                                <div class="sl-left"> <img src="{{asset('backend/assets/images/users/4.jpg')}}" alt="user" class="img-circle"> </div>
                                <div class="sl-right">
                                    <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
