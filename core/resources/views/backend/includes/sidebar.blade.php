    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-youtube-play"></i><span class="hide-menu">Videos</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{route('admin.videos')}}">View Videos</a></li>
                        <li><a href="{{route('admin.videos.import')}}">Import Videos</a></li>
                    </ul>
                </li>
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-movie"></i><span class="hide-menu">Category</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{route('admin.categories')}}">View Categories</a></li>
                        <li><a href="{{route('admin.categories.new')}}">Add New</a></li>
                    </ul>
                </li>
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-web"></i><span class="hide-menu">Channels</span></a>
                    <ul aria-expanded="false" class="collapse">
