...
<html class="no-js" lang="{{ app()->getLocale() }}">
    ...
    <body>
        ...
        <script src="{{asset('assets/bower_components/what-input/what-input.min.js')}}"></script>
        <script src="{{asset('assets/bower_components/foundation-sites/dist/foundation.min.js')}}"></script>
        <script src="{{asset('assets/js/min/jquery.showmore.src-min.js')}}" type="text/javascript"></script>
        ...
        <script src="{{asset('assets/js/min/jquery.kyco.easyshare-min.js')}}" type="text/javascript"></script>
        @section('scripts')
        @show
    </body>
</html>