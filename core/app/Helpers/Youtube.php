...
class Youtube {
     ...
     */
    public function searchVideos($q, $maxResults = 10, $region = null, $order = null) {
        $params = array(
            'q' => $q,
            'type' => 'video',
            'part' => 'id, snippet',
    ...
    public function getSearchParams($q, $type = 'video', $maxResults = 10, $region = null, $order = null) {
        $params = array(
            'q' => $q,
            'type' => $type,
            'part' => 'id, snippet',
     ...
     * @return object
     */
    public function searchChannelVideos($q, $channelId, $maxResults = 10, $order = null, array $otherParams = [], $pageInfo = true) {
        $params = array(
            'q' => $q,
            'type' => 'video',
            'channelId' => $channelId,
     ...
     * @return object
     */
    public function getChannelVideosParams($channelId, $q = null, $maxResults = 10, $order = null) {
        $params = array(
            'type' => 'video',
            'channelId' => $channelId,
            'part' => 'id, snippet',
     ...
     * @return array
     */
    public function listChannelVideos($channelId, $maxResults = 10, $order = null, $pageInfo = false) {
        $params = array(
            'type' => 'video',
            'channelId' => $channelId,
            'part' => 'id, snippet',
    ...
    /*
     * Get result and return only the page information
     * Total items, etc.
     */

    public function getResultInfo(array $params) {
        $result = $this->searchAdvanced($params, true);
        return $result['info'];
    }
